...
<head>
    ...
    <meta name="description" content="Halaman yang tujuan anda tidak ditemukan.">
        ...
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center gap-5" style="min-height: 90vh;">
                ...
                <div class="text-center">
                    <h1 class="h4 fw-bold mb-2">Halaman Tidak Ditemukan</h1>
                    <p>Halaman yang tujuan anda tidak ditemukan. Pastikan alamat tujuan anda sudah benar.</p>
                </div>
            </div>
        </div>
    </section>
